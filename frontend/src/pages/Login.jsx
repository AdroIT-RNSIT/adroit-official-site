          ...
          <div className="relative bg-black/40 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl p-4">
            ...
            <div className="mb-6 flex gap-2 bg-white/5 backdrop-blur-sm p-1 rounded-lg border border-white/10">
              <button
                ...
                className={`flex-1 py-2 px-4 rounded-md font-medium transition-all ${!isSignUp
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              {/* Forgot Password Section (Sign In Only) */}
              {!isSignUp && !forgotMode && (
                ...
                <div className="bg-white/5 border border-white/10 rounded-xl p-4 space-y-3">
                  {forgotSuccess ? (
                    <div className="text-center">
                      ...
                      <p className="text-gray-500 text-xs mt-1">Check your email inbox for the password reset link.</p>
                      <button
                        type="button"
                        onClick={() => {
                          setForgotMode(false);
                    ...
                    <>
                      <p className="text-sm text-gray-300 font-medium">Reset your password</p>
                      ...
                      <input
                        ...
                        placeholder="your@email.com"
                        className="w-full px-3 py-2 rounded-lg border border-white/10 bg-white/5 text-white placeholder-gray-500 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500/20 outline-none transition-all text-sm"
                      />
                      <div className="flex gap-2">
                        <button
                          type="button"
                          onClick={() => setForgotMode(false)}
                          className="flex-1 py-2 px-3 text-sm text-gray-400 hover:text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-all"
                        >
                          Cancel
                        </button>
                        <button
                          ...
                          className="flex-1 py-2 px-3 text-sm text-white font-medium bg-gradient-to-r from-cyan-500 to-purple-600 rounded-lg hover:scale-[1.02] transition-all disabled:opacity-50"
                        >
                          {forgotLoading ? (
