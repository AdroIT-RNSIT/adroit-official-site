export const sharedEvents = [
  {
    ...
    rules: [
      ...
      "Any form of network attack (DDoS, etc.) against the event infrastructure is strictly prohibited.",
  ...
  },
  {
    ...
    rules: [
      "Teams are given a fixed virtual currency for bidding.",
      "Projects must be built ONLY with the technologies acquired during the auction.",
  ...
  },
  {
    ...
    rules: [
      "All major AI generation tools (Midjourney, Runway, Sora, etc.) are permitted.",
      "Final submissions must not exceed 3 minutes.",
      "Teams must disclose all AI tools used in their credits sequence."
    ]
  }
];
